...
export default class FeaturedRooms extends Component {
    state = {featuredrooms: [
        {
            image: <a href='./rooms'> <img src={Featured1} alt="Room Eva" width="300px" height="200px" /></a>,
            title: "Room Eva",
        },
        {
            image: <a href='./rooms'> <img src={Featured2} alt="Room Alberto" width="300px" height="200px" /></a>,
            title: "Room Alberto",
        },
        {
            image: <a href='./rooms'> <img src={Featured3} alt="Room Nouise" width="300px" height="200px" /></a>,
            title: "Room Nouise",
        },
